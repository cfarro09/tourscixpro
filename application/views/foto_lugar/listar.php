    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left">Listar Fotos de Lugares Turisticos</h4>

                    <ol class="breadcrumb float-right">
                        <li class="breadcrumb-item"><a href="#">Adminox</a></li>
                        <li class="breadcrumb-item"><a href="#">Fotos de Lugares Turisticos</a></li>
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="card-box">
                    <h4 class="header-title m-t-0 m-b-20">Mantenimiento de Fotos de Lugares Turisticos</h4>
                                ...
                                <?php foreach ($fotos_lugares as $row) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= site_url() ?>foto_lugar/editar/<?= $row->cod_foto ?>"><i class="action fa fa-edit edit_list"></i></a>
                                            <a href="#" data-cod_foto="<?= $row->cod_foto ?>" data-name_foto="<?= $row->name_foto ?>" data-action="foto_lugar/delete_foto_lugar" class="fa fa-trash pl-2 remove_foto action"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            <?php endif ?>
