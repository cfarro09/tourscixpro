...
if (!function_exists('prueba_helper_modal2')) {

    //formateamos la fecha y la hora, función de cesarcancino.com
    function prueba_helper_modal2() {
        return APPPATH.'third_party/htmlpurifier-4.9.3-standalone/HTMLPurifier.standalone.php';
    }
